...
// import { matchBodyProgress, matchBodySymbol, matchBodyDash, matchInfos } from '../../lib/parser.js'

// describe.only('Unit: parser.js', function () {
...
//   it('matchBodySymbol() should return file on add', function () {
...
//   it('matchBodySymbol() should return file on update', function () {
...
//   it('matchBodySymbol() should return file on test', function () {
...
//   it('matchBodySymbol() should return file on remaining', function () {
...
//   it('matchBodySymbol() should return file on delete', function () {
//     const r = matchBodySymbol('. test/file')
//     expect(r).to.be.an('object')
//     expect(r['symbol']).to.equal('.')
//     expect(r['file']).to.equal('test/file')
...
//   it('matchBodySymbol() should return file on extracted', function () {
//     const r = matchBodySymbol('- test/file')
//     expect(r).to.be.an('object')
//     expect(r['symbol']).to.equal('-')
//     expect(r['file']).to.equal('test/file')
...
//   it('matchBodySymbol() should return file on Windows drive', function () {
...
//   it('matchBodySymbol() should return file on Windows remote', function () {
...
//   it('matchBodySymbol() should return file with emoji☕️', function () {
...
//   // @TODO matchBodyDash
//   it('matchBodyDash() should return null on non match', function () {
//     const r = matchBodyDash('Todo: 1')
//     expect(r).to.be.equal(null)
//   })

//   it('matchBodyDash() should hash on file', function () {
//     const r = matchBodyDash('7E9C36FF6828353A             9  DirExt/sub1/sub1.txt')
//     expect(r).to.be.an('object')
...
//   it('matchBodyDash() should return file on Windows drive', function () {
//     const r = matchBodyDash('7E9C36FF6828353A             9   C:\\test\\file')
//     expect(r).to.be.an('object')
//     expect(r['hash']).to.equal('7E9C36FF6828353A')
//     expect(r['size']).to.equal(9)
//     expect(r['file']).to.equal('C:\\test\\file')
...
//   it('matchBodyDash() should return file on Windows remote', function () {
//     const r = matchBodyDash('7E9C36FF6828353A             9   \\test\\file')
//     expect(r).to.be.an('object')
//     expect(r['file']).to.equal('\\test\\file')
//     expect(r['hash']).to.equal('7E9C36FF6828353A')
//     expect(r['size']).to.equal(9)
...
//   it('matchBodyDash() should return file with emoji☕️', function () {
//     const r = matchBodyDash('7E9C36FF6828353A             9   test/f☕️le')
//     expect(r).to.be.an('object')
//     expect(r['file']).to.equal('test/f☕️le')
//     expect(r['hash']).to.equal('7E9C36FF6828353A')
//     expect(r['size']).to.equal(9)
...
//   it('matchBodyDash() should match on directory', function () {
//     const r = matchBodyDash('               DirExt/sub1')
//     expect(r).to.be.an('object')
//     expect(r['file']).to.equal('DirExt/sub1')
//   })

//   it('matchBodyDash() should hash on non-sized file', function () {
//     const r = matchBodyDash('               DirExt/sub1/sub1.txt')
//     expect(r).to.be.an('object')
